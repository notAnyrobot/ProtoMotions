...
**Newton simulator**: Tested against Newton 1.0.0 from PyPI. Install via `pip install -c requirements_newton.txt "newton[examples]==1.0.0"` — see `requirements_newton.txt`.
