...
#
# Convenience launcher for ProtoMotions Newton + PyRoki Docker on a workstation.
...
NEWTON_LAUNCHER_PROFILE="workstation"
...
IPC_MODE="${PROTO_HPC_IPC_MODE:-host}"
SHM_SIZE="${PROTO_HPC_SHM_SIZE:-16g}"
